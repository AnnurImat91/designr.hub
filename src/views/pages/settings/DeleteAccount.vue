    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="w-full">
        <div class="flex flex-col sm:flex-row">
          <div class="p-4">
            <h2 class="text-lg font-semibold mb-2">Are you sure you want to delete this account?</h2>
            <Checkbox label="I have read terms & condition" />
            <div class="mt-5">
              <button
                type="button"
                class="text-white bg-primary hover:bg-blue-600 rounded-lg text-sm px-10 py-1.5 me-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
              >
                Yes
              </button>
              <button type="button" class="hover:bg-gray-100 border rounded-lg text-sm px-10 py-1.5 me-2 mb-2 dark:bg-dark-600 dark:hover:bg-dark-700 focus:outline-none dark:focus:ring-primary-800">
                No
              </button>
            </div>
          </div>
